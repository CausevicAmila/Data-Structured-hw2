...
public class IPaddress implements Comparable<IPaddress> {
	...
	public static IPaddress[] readNumbers(String path) throws FileNotFoundException {
        ...
        int i = 0; 
        while (scanner.hasNextLine() && i<10000) {
	...
	public static long converter(String ipadd) {
		String[] array = new String[3];
		array = ipadd.split("\\.");
		long num = Integer.parseInt(array[0]) * 16777216 + Integer.parseInt(array[1]) * 65536 + Integer.parseInt(array[2] + 256 +Integer.parseInt(array[3]));
		return num;
